...
One really exquisite ggplot extension I would like to highlight is [esquisse](https://dreamrs.github.io/esquisse/). This package creates a tableau-like interface inside of Rstudio, so that we can interactively plot our data! It has been a game changer for me when doing EDA.
...
Scaling is a crucial part of effective data communication. If the scale of the data is not clear, then any inferences from that communication will either be unclear or misled. The [scales package](https://scales.r-lib.org/) provides some awesome tooling to make very clear and descriptive plot scales.
